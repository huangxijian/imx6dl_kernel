...
/*xinshida & jh  
#define sabresd_BKL_NON         16
#define LCD_ON     92  */

/* fr */
#define sabresd_BKL_NON         20
#define LCD_ON     18  
#define sabresd_BKL_NON_1         46
#define LCD_ON_1     43  
		    ...
		    struct mxc_dispdrv_setting *setting)
{
	...
	gpio_request(LCD_ON, "LCD_ON");
	gpio_direction_output(LCD_ON, 0);
	mdelay(10);
//	gpio_free(LCD_ON);  
	gpio_free(LCD_ON);
	
	gpio_request(sabresd_BKL_NON, "sabresd_BKL_NON");
	gpio_direction_output(sabresd_BKL_NON, 0);
	mdelay(10);  
	gpio_free(sabresd_BKL_NON);   
	
	gpio_request(LCD_ON_1, "LCD_ON_1");
	gpio_direction_output(LCD_ON_1, 0);
	mdelay(10);  
	
	gpio_request(sabresd_BKL_NON_1, "sabresd_BKL_NON_1");
	gpio_direction_output(sabresd_BKL_NON_1, 0);
	mdelay(10);  
	gpio_free(sabresd_BKL_NON_1);   
