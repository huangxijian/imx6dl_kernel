...
{
	printk("------------sgtl5000_set_dai_sysclk --------- freq = %d\n",freq);
	struct snd_soc_codec *codec = codec_dai->codec;
	struct sgtl5000_priv *sgtl5000 = snd_soc_codec_get_drvdata(codec);
	freq = 11289600;
	switch (clk_id) {
...
//		frac_div = 786;
		...
		printk("djr ------- int_div = %d  frac_div = %d\n",int_div,frac_div);
